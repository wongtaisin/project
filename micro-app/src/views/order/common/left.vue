 ...
 * @FilePath: \PCB-\src\views\order\common\left.vue
 * @Description: left
-->
<template>
	<section>
		<el-affix :offset="80">
			<div class="left">
				<el-anchor :offset="100">
					<el-anchor-link :href="`#${res['title']}`" :key="i" class="menu" v-for="(res, i) in item">
						<!-- <i :class="`iconfont` + ' ' + res.icon" /> -->
...
const item = ref([
	...
	{
		icon: 'icon-jibenxinxi1',
		font: '基本信息',
		title: 'information'
	},
	{
		icon: 'icon-qitachajianqu',
		font: 'SMT贴片及插件',
		title: 'smt'
	},
	{
		icon: 'icon-routing-orange',
		font: '制造工艺',
		title: 'craft'
	},
	{
